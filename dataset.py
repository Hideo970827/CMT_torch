...
class ChordMusicDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        instance['chord'] = torch.Tensor(instance['chord']).long().numpy()
        instance['pitch']=  torch.Tensor(instance['pitch']).long().numpy()
        instance['rhythm']= torch.Tensor(instance['rhythm']).long().numpy()
